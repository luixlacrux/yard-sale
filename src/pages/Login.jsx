		...
		<div className="Login">
			<div className="Login-container">
				...
				<form action="/" className="form" ref={form} onSubmit={handleSubmit}>
					...
					<input type="text" name="email" placeholder="platzi@example.cm" className="input input-email" onChange={handleInput} />
				...
				<button className="secondary-button signup-button" onClick={() => window.location = "/signup"}>Sign up</button>
			</div>
		</div>
	);
}
